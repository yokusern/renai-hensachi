...
import { computeResult } from "@/lib/inka-scoring";

export default function InkaQuizPage() {
      ...
      setTimeout(() => {
        ...
        if (current < total - 1) {
          ...
          const params = new URLSearchParams({
            ...
            hi: String(result.normalizedScores.hitomishiri),
            bo: String(result.normalizedScores.bocchi),
            hb: String(result.normalizedScores.hobbies),
            ga: String(result.normalizedScores.groupAversion),
            iv: String(result.normalizedScores.invisible),
            r: result.rank,
            re: result.rankEmoji,
            str: result.strength,
            wk: result.weakness,
          ...
          router.push(`/inka/result?${params.toString()}`);
        }
      }, 220);
    },
        ...
        <div className="w-full max-w-xl">
          <div className="flex items-center justify-between mb-8">
            <button
              ...
              style={{
                color: current === 0 ? "rgba(90,74,122,0.3)" : "#7a5a99",
            ...
            <span className="text-sm font-bold" style={{ color: "#7a5a99" }}>
